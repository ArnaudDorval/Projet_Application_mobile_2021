...
class RestaurantDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView = this.findViewById(R.id.restaurantDetails_mapView)
        if (mapView != null) {
    ...
    private fun displayRestaurant(restaurant: Restaurant) {
        val nameTextView = findViewById<TextView>(R.id.restaurantDetails_nameRestTextView)
...
private fun MapView.getMapAsync(restaurantDetailsActivity: RestaurantDetailsActivity) {
